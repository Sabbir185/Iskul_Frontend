        ...
        <section>
            <div className='bg-gray-200 h-full w-full md:grid md:grid-cols-3 md:gap-3 p-4 mt-3 rounded-lg'>
                <div className='bg-gray-300 rounded-md h-full w-full p-3'>
                    <div className='image bg-gray-50 h-52  rounded-md relative'>
                        <div className='w-28 h-28 border-2 rounded-full shadow-sm cursor-not-allowed'>
                            {
                                image !== 'avatar.png' ?
                                    <img src={imgUrl} alt='profile-pic' className='shrink object-cover rounded-full' />
                                    :
                                    <Image  alt='profile-pic' className='shrink object-cover rounded-full' />
                            }
                        </div>

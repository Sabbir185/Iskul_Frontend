...
const ViewAllTeacher = () => {
            ...
            async function getData() {
                ...
                if (!!id) {
                    try {
                        ...
                        const result = await axios.get(`http://localhost:8080/api/user/get-data-schoolId-role/${id}/teacher`, config);
    ...
    const editHandler = (firstName, lastName, email, id) => {
        router.push(`/school/teacher/${firstName}/${lastName}/${email}/${id}`)
    }

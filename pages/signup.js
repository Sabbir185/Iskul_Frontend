...
const Signup = () => {
	...
	<div>
        <div className="relative md:h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 bg-gray-500 bg-no-repeat bg-cover relative items-center bg-img">
            ...
            <div className="flex flex-wrap w-3/5 space-y-4  place-content-between py-6 px-10 bg-white rounded-xl z-10">
                ...
                <div className="w-3/5 border-l-2 p-10">
                    <Form
                        onFinish={onFinish}
                        initialValues={{
                            remember: true,
                        ...
                        >
                            <Input.Password className="shadow appearance-none border w-full py-2 px-3 text-gray-900 mb-3 leading-tight focus:outline-none focus:shadow-outline" />
                        </Form.Item>
                        <Form.Item
